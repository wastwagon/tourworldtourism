        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center py-2 gap-y-3 md:gap-y-0 text-[11px] sm:text-sm">
            ...
            <div className="flex items-center space-x-5 border-t border-white/20 pt-2 md:border-t-0 md:pt-0 md:space-x-4">
              ...
              <a
                href="https://twitter.com/tourworldtourism"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-yellow-200 transition-colors"
                aria-label="Twitter"
              ...
              <a
                href="https://instagram.com/tourworldtourism"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-yellow-200 transition-colors"
              ...
              <a
                href="https://youtube.com/tourworldtourism"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-yellow-200 transition-colors"
                aria-label="YouTube"
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex items-center">
            <Image
              src="/logo.png"
              alt="TOURWORLD TOURISM SERVICES LTD"
              width={180}
              height={70}
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  ...
                  href={link.href}
                  className={`
                    relative px-4 lg:px-5 py-2 lg:py-2.5 text-sm lg:text-base font-semibold rounded-lg transition-all duration-300
                    ${active
                ...
                >
                  {link.label}
                  {active && (
                    <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-8 h-1 bg-red-600 rounded-t-full"></span>
                  )}
                </Link>
              )
            })}
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <Link
                    ...
                    className={`
                      px-4 py-2.5 sm:py-3 text-sm sm:text-base font-semibold rounded-lg transition-all duration-300
                      ${active

// Add June 2025 Ghana Culture, Heritage & Eco-Tourism Tour
...
const juneTour = {
  title: "10-Day Ghana Culture, Heritage & Eco-Tourism Tour - June 2025",
  description: "A comprehensive 10-day journey through Ghana's rich culture, heritage, and eco-tourism sites. Visit Accra, Cape Coast, Elmina, and Kumasi. Experience historic slave castles, Kakum National Park canopy walk, Assin Manso slave memorial, Ashanti cultural sites with naming ceremony, craft villages, and special visit to African University of Communications and Business. Includes custom African dress tailoring.",
  durationDays: 10,
  durationNights: 9,
  ...
  highlights: [
    "Money Exchange",
    "Special visit to African University of Communications and Business (AUCB)",
  ...
  itinerary: [
    {
      ...
      activities: [
        ...
        "Group to do money exchange",
        "At 3pm, the group will be guests of African University of Communications and Business (AUCB)",
      ...
      notes: "Arrival day with special university visit, orientation and custom dress ordering"
    },
    {
      day: 2,
    ...
    },
    {
      ...
      meals: "Breakfast and Dinner",
      accommodation: "Lancaster Kumasi City Hotel",
      notes: "Cultural immersion day with personalized naming ceremony"
    },
    {
      day: 6,
  ...
  featured: true,
  status: "active",
  featuredImage: "/images/tours/june-2025-tour.jpg",
  galleryImages: [],
  groupSizeMin: null,
  groupSizeMax: null,
  availableDates: ["2025-06-21"],
  notes: "Tour dates: June 21-30, 2025. Delta Airlines flight. This comprehensive tour combines culture, heritage, and eco-tourism. Features visits to historic slave castles, Kakum National Park, Assin Manso slave memorial with river ceremony, Ashanti cultural sites with naming ceremony, craft villages, and special visit to African University of Communications and Business (AUCB). Includes custom African dress tailoring and early morning departure on Day 10.",
  pricePerPerson: 0,
  singleSupplement: null
}

async function addJuneTour() {
  try {
    console.log('🔄 Adding June 2025 Ghana Culture, Heritage & Eco-Tourism Tour...\n')
    ...
    const slug = createSlug(juneTour.title)
    ...
    console.log('✅ June 2025 Tour added successfully!')

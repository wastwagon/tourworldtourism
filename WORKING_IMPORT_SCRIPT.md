# ✅ Working Import Script (Fixed!)

The issue is trailing commas. This script removes them and imports:

## Update Script in Coolify Terminal
...
async function cleanAndImport() {
  ...
  // Remove trailing commas (this fixes the JSON structure)
...
**The key fix: Added removal of trailing commas before `}` and `]`**
